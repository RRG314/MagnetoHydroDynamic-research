...
1. Add constrained transport compatibility hooks
...
1. Optional integration with GPU backends
2. Optional PyTorch/JAX residual optimization backends
3. Expand problem library with additional standard MHD verification tests
